...
logger = logging.getLogger("ts_discord_command_bot")
...
class ts_discord_command_bot(discord.Client):

    def setup(self, commandfile):
        self._commandfile = commandfile
        self.base_commands = {}
        self.rate_limited_calls = {}
        self.search_base_url = 'https://www.tradescope.khulnasoft.com/en/latest/?q='
        self.gh_base_url = 'https://github.com/khulnasoft/tradescope/search?q='
...
def add_arguments():
    ...
    parser.add_argument('-c', '--commands',
                        ...
                        default=('https://raw.githubusercontent.com/'
                                 'khulnasoft-lab/ts_discord_bot/master/'
                                 'bot_commands.json')
                        )
...
def main(args):
    ...
    client = ts_discord_command_bot(intents=intents)
